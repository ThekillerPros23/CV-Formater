...
class HotelStaffPDF(FPDF):
    ...
    def footer(self):
        ...
        self.set_x(-60)
        self.cell(0, 3.5, 'Código: F-PMSSA-01', ln=True, align='R')
        self.set_x(-60)
...
class BosunPDF(FPDF):
    ...
    def footer(self):
        ...
        self.set_font('calibri', 'I', 9)
        self.set_x(-60)
        self.cell(0, 3.5, 'Código: F-PMSSA-01-D', ln=True, align='R')
        self.set_x(-60)
        self.cell(0, 3.5, 'Revisión: 02', ln=True, align='R')
        self.set_x(-60)
        self.cell(0, 3, 'Fecha: 07 de noviembre de 2024', ln=True, align='R')
...
class OilerPDF(FPDF):
    ...
    def footer(self):
        ...
        self.set_font('calibri', 'I', 9)
        self.set_x(-60)
        self.cell(0, 3.5, 'Código: F-PMSSA-01-G', ln=True, align='R')
        self.set_x(-60)
        self.cell(0, 3.5, 'Revisión: 02', ln=True, align='R')
        self.set_x(-60)
        self.cell(0, 3, 'Fecha: 07 de noviembre de 2024', ln=True, align='R')
...
class FitterPDF(FPDF):
    ...
    def footer(self):
        ...
        self.set_font('calibri', 'I', 9)
        self.set_x(-60)
        self.cell(0, 3.5, 'Código: F-PMSSA-01-F', ln=True, align='R')
        self.set_x(-60)
        self.cell(0, 3.5, 'Revisión: 02', ln=True, align='R')
        self.set_x(-60)
        self.cell(0, 3, 'Fecha: 07 de noviembre de 2024', ln=True, align='R')
...
class OfficerPDF(FPDF):
    ...
    def footer(self):
        ...
        self.set_font('calibri', 'I', 9)
        self.set_x(-60)
        self.cell(0, 3.5, 'Código: F-PMSSA-01-A', ln=True, align='R')
        self.set_x(-60)
        self.cell(0, 3.5, 'Revisión: 02', ln=True, align='R')
        self.set_x(-60)
        self.cell(0, 3, 'Fecha: 07 de noviembre de 2024', ln=True, align='R')
