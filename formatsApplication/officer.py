...
class OfficerApplication():
    def format_officer(self, pdf, database, uid,version,database_email):
...
# Lista de documentos predeterminada
        ...
        training = Training()
        training.officer(pdf,database,uid,version)
