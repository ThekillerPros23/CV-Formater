...
from formatskillApplication.fitter import *
import requests
...
from trainingApplication.fitter import *
from number import *
import phonenumbers
...
class FitterApplication():
    def format_fitter(self, pdf, database, uid,version,database_email):
...
# Lista de documentos predeterminada
        ...
        training = Training()
        training.fitter(pdf,database,uid,version)
        ...
        pdf.ln(10)
        skills = Skills()
        skills.fitter(pdf, database,uid,version)
        #skills.messman(pdf)
        pdf.ln(10)
