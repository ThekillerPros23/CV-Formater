...
from formatskillApplication.oiler import *
import requests
...
from trainingApplication.oiler import *
from number import *
import phonenumbers
...
class OilerApplication():
    def format_oiler(self, pdf, database, uid,version,database_email):
...
# Lista de documentos predeterminada
        ...
        training = Training()
        training.oiler(pdf,database,uid,version)
