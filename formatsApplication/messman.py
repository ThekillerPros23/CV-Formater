...
from formatskillApplication.messman import *
import requests
...
class MessmanApplication():
    def format_messman(self, pdf, database,uid,version,database_email):
        ...
        # Nacionalidad
        nationality = database.marine_nationality(uid,version) or ""
        pdf.set_xy(80, 107)
      ...
      # Posición inicial
        ...
        others_lang = database.marine_lang_other(uid,version) or []
...
# Lista de documentos predeterminada
            ...
            for document in personalDocuments:
                ...
                if doc_name == document_name.upper():
                    ...
                    try:
                      ...
                      # Detener la búsqueda una vez encontrado el documento correspondiente
        ...
        training = Training()
        training.messman(pdf,database,uid,version)
   ...
   # Setting up the PDF structure
        ...
        pdf.ln(10)
        skills = Skills()
        skills.messman(pdf, database,uid,version)
        #skills.messman(pdf)
        pdf.ln(10)