class HotelStaffCourses:
    def courses(self):
        courses = {
            ...
            6: "Security Awareness Training for all Seafarers with Designated Security Duties IMO 3.26",
            10: "Safety Training for Personnel Providing Direct Services to Passengers in Passenger Spaces IMO 1.44",
