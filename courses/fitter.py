class FitterCourses():
    ...
    "Safety Training for Personnel Providing Direct Services to Passenger in Passenger Spaces 1.44",
    ...
    "Basic Training for Oil and Chemical Cargo Tanker Operations 1.01",
    "Advanced Fire Fighting 2.03",
    "Ratings Forming Part of an Engineering Watch 7.09",
    "Able Engine Course"]
